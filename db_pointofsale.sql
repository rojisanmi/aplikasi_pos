...
(5, 'Roji Ihsan Azmi', 'Pria', 'Bandung', '0800'),
(6, 'Revan Naufal Arifin', 'Wanita', 'Bogor', '121212');
...
CREATE TABLE `pengguna` (
  ...
  `photo_user` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `pengguna` (`id`, `username`, `password`, `nama`, `role`, `photo_user`) VALUES
(1, 'admin', '$2y$10$/I7laWi1mlNFxYSv54EUPOH8MuZhmRWxhE.LaddTK9TSmVe.IHP2C', 'Admin', '1', 'avatar51.png'),
(2, 'ibrahimalanshor', '$2y$10$5thNuizSyAdrGXC9A/WYd.StNiSRUy0eBZJ401hGBfUpwGINu9kyG', 'Ibrahim Al Anshor', '2', 'user2-160x160.jpg'),
(3, 'ihsan', '$2y$10$DQGkSZrPhrUYcPLU0rqtJ.BgQnmL8UmgHBFJdpFronKBj8zLOosae', 'Roji Ihsan Azmi', '2', 'Screenshot_2022-04-03_152627.png'),
(8, 'roji_sanmi', '$2y$10$wCFPCzsLhEw3ArhLbbBBQOBAKRYLZj/D6iRB441OvDnYasmHMuTaC', 'Roji Ihsan Azmah', '2', 'POSTER_(1080_×_1080_px).png');
...
(1, 'THKTK-ULTRAJAYA', 'Teh Kotak', 2, 5, '25000', 0, ''),
(2, 'MKNCHUBA', 'Snack Chuba', 1, 5, '50000', 0, ''),
(3, 'BKTLS-SIDU', 'Buku Tulis', 4, 5, '24000', 80, '9'),
(4, 'uuuaa', 'Teh KOtak uuaa', 2, 5, '50000', 37, '1'),
(5, 'OPO', 'Buku Tulis Opo', 4, 1, '24000', 9, '1'),
(6, 'SNKARIES', 'Snack aRIES', 1, 5, '30000', 14, '1'),
(7, 'cristianoronaldoisthegoat', 'CR', 6, 6, '5000000', 0, '1');
...
(1, '2022-05-12 14:56:28', 3, '3', 'hilang'),
(2, '2022-05-12 15:06:50', 4, '10', 'kadaluarsa'),
(3, '2022-05-12 15:20:30', 5, '2', 'hilang'),
(4, '2022-05-12 15:46:09', 6, '5', 'kadaluarsa');
...
(1, '2022-05-12 14:56:05', 3, '100', 'penambahan', 1),
(2, '2022-05-12 14:05:08', 4, '50', 'penambahan', 6),
(3, '2022-05-11 15:35:38', 5, '12', 'penambahan', 1),
(4, '2022-05-11 14:00:20', 6, '20', 'penambahan', 7),
(5, '2023-07-30 19:45:03', 7, '1', 'penambahan', 7);
...
(1, 'Surya Abadi Tbk.', 'Surabaya', '088250089674', 'PT SIDU Tangerang'),
(7, 'Mutiara Bogor', 'Bogor', '900', 'pT. CHUBA SEJAHTERA'),
(9, 'Revan Naufal Arifin', 'London', '9102992019', 'fans cristiano');
...
(1, 'Toko Ihsan', 'Kab. Bandung, Jawa barat');
...
(3, '2022-05-12 15:12:19', '4,3', '1,1', '74000', '100000', '', 2, 'RHOJGRXOZGV190N', 1),
(4, '2022-05-12 15:12:48', '4,3', '1,1', '74000', '100000', '', 2, 'T3FWAF3FJ7JF6EY', 1),
(6, '2022-05-12 15:47:19', '6,3', '9,1', '246000', '250000', '', 1, 'MEBBHX94BY17M0X', 1),
(7, '2023-07-30 19:45:48', '7', '1', '5000000', '10000000', '2000000', 5, '7UNWL6ZFH3O34ZU', 3);
